...
NAME=$(curl -sS https://raw.githubusercontent.com/mexxv/access/main/ip | grep $IPVPS | awk '{print $2}')
EXP=$(curl -sS https://raw.githubusercontent.com/mexxv/access/main/ip | grep $IPVPS | awk '{print $3}')
clear
